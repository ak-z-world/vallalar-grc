...
export const metadata = {
  ...
  description:
    "Explore our premium GRC and GRP architectural solutions including facades, columns, cornices, domes, and jaalis in Chennai and Tamil Nadu.",
};
  ...
  return (
    <main className="font-sans text-gray-800 bg-[#F9F9F9] selection:bg-[#C5A26B] selection:text-white min-h-screen">
      ...
      <div className="sr-only">
        ...
        <p>
          Discover the finest Glass Fiber Reinforced Concrete (GRC) and Glass
          Reinforced Plastic (GRP) solutions at Vallalar GRC. We are recognized
          as the best GRC in Chennai and a leading manufacturer in Tamil Nadu.
          Our services include manufacturing and installing chennai grc facades,
          GRC columns, elegant cornices, lightweight domes, intricate GRC
          jaalis, and custom decorative panels. If you are searching for 'grc in
          chennai', 'grc chennai', or 'best grc in tamil nadu', Vallalar GRC is
          your ultimate destination for high-performance, weather-resistant, and
          aesthetically superior architectural elements. Serving Chennai,
          Chennai, and all of South India.
        </p>
      </div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-300 text-sm leading-relaxed max-w-md">
              Premium GRC & GRP architectural solutions that combine design
              freedom, structural performance and timeless beauty.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={idx}
                className="bg-white group cursor-pointer shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col h-full">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <h4 className="text-[13px] font-bold tracking-wider text-gray-900 mb-3 uppercase">
                    {service.title}
                  </h4>
            ...
            {[
              {
                ...
                desc: "Endless design possibilities with custom-made architectural elements.",
              },
              {
                icon: <ShieldCheck size={24} />,
                title: "LIGHTWEIGHT & STRONG",
                desc: "High strength-to-weight ratio for safer and more efficient construction.",
              },
              {
                icon: <CloudRain size={24} />,
                title: "DURABLE & WEATHER RESISTANT",
                desc: "Engineered to withstand harsh weather and time.",
              },
              {
                icon: <Settings size={24} />,
                title: "LOW MAINTENANCE",
                desc: "Long-lasting beauty with minimal upkeep and lower life-cycle cost.",
              },
              {
                icon: <Leaf size={24} />,
                title: "SUSTAINABLE SOLUTION",
                desc: "Eco-friendly materials and processes for a better tomorrow.",
              },
            ].map((feature, idx) => (
              <div
                key={idx}
                className="flex flex-col items-center text-center px-4">
                <div className="text-[#C5A26B] mb-4">{feature.icon}</div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative mt-20">
            ...
            <div className="absolute top-[40px] left-[8%] right-[8%] h-[2px] bg-[#C5A26B]/20 hidden md:block z-0">
              ...
              <div className="absolute left-[16.6%] top-1/2 -translate-y-1/2 -translate-x-1/2 text-[#C5A26B]/50">
                <ArrowRight size={14} />
              </div>
              <div className="absolute left-[33.3%] top-1/2 -translate-y-1/2 -translate-x-1/2 text-[#C5A26B]/50">
                <ArrowRight size={14} />
              </div>
              <div className="absolute left-[50%] top-1/2 -translate-y-1/2 -translate-x-1/2 text-[#C5A26B]/50">
                <ArrowRight size={14} />
              </div>
              <div className="absolute left-[66.6%] top-1/2 -translate-y-1/2 -translate-x-1/2 text-[#C5A26B]/50">
                <ArrowRight size={14} />
              </div>
              <div className="absolute left-[83.3%] top-1/2 -translate-y-1/2 -translate-x-1/2 text-[#C5A26B]/50">
                <ArrowRight size={14} />
              </div>
            </div>
              ...
              {[
                {
                  num: "01",
                  title: "CONSULTATION",
                  desc: "Understanding your vision, requirements and site conditions.",
                  icon: <MessageSquare size={24} strokeWidth={1.5} />,
                },
                {
                  num: "02",
                  title: "DESIGN & ENGINEERING",
                  desc: "Creating detailed drawings and 3D models with precision.",
                  icon: <LayoutTemplate size={24} strokeWidth={1.5} />,
                },
                {
                  num: "03",
                  title: "MANUFACTURING",
                  desc: "Advanced molding and casting using premium materials.",
                  icon: <Factory size={24} strokeWidth={1.5} />,
                },
                {
                  num: "04",
                  title: "QUALITY CHECK",
                  desc: "Rigorous inspection to ensure flawless finish and strength.",
                  icon: <ClipboardCheck size={24} strokeWidth={1.5} />,
                },
                {
                  num: "05",
                  title: "DELIVERY & INSTALLATION",
                  desc: "Safe delivery and expert installation for a perfect finish.",
                  icon: <Truck size={24} strokeWidth={1.5} />,
                },
                {
                  num: "06",
                  title: "PROJECT COMPLETION",
                  desc: "On-time completion with a commitment to excellence.",
                ...
                <div
                  ...
                  <h4 className="text-gray-900 text-[10px] font-bold tracking-wider mb-3 uppercase mt-4">
                    {step.title}
                  </h4>
                  <p className="text-gray-500 text-[10px] leading-relaxed max-w-[140px]">
                    {step.desc}
                  </p>
                </div>
              ))}
