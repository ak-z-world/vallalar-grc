        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            ...
            <div className="flex gap-2">
              <button className="p-3 border border-gray-300 rounded-full text-gray-500 hover:bg-[#C5A26B] hover:text-white transition-colors" aria-label="Previous">
                <ChevronLeft size={20} />
              </button>
              <button className="p-3 border border-gray-300 rounded-full text-gray-500 hover:bg-[#C5A26B] hover:text-white transition-colors" aria-label="Next">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { name: "Yuvaraj", role: "Managing Director", img: "/api/placeholder/400/400" },
              { name: "S. Karthikeyan", role: "Director - Operations", img: "/api/placeholder/400/400" },
              { name: "S. Aravind", role: "Director - Projects", img: "/api/placeholder/400/400" }
            ].map((person, idx) => (
              <div key={idx} className="group cursor-pointer">
                ...
                <p className="text-[#C5A26B] text-xs font-semibold tracking-wider uppercase">{person.role}</p>
              </div>
            ))}
          </div>
        </div>
